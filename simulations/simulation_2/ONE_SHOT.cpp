...
int main(int argc, char *argv[]){
    ...
    std::string output_dir = "output/" +  n_locs  + "/" + sim + "/";
    ...
    vector_t exps = vector_t::LinSpaced(100,-6,1);
